              ...
              {forwarding.slice(0, 4).map((f) => {
                ...
                return (
                  <a
                    ...
                    className="bg-white rounded-2xl border border-slate-100 p-4 md:p-5 shadow-sm
                               hover:shadow-lg hover:border-purple-200 transition-all duration-200 active:scale-[0.99]"
                  >
                    ...
                    <div className="text-base font-bold text-slate-900 mb-1 break-words">
                      {clientName}
                    </div>
              ...
              {trips?.slice(0, 4).map((trip) => {
                ...
                return (
                  <a
                    ...
                    href={`/trips/${trip.id}`}
                    className="bg-white rounded-2xl border border-slate-100 p-4 md:p-5 shadow-sm
                               hover:shadow-lg hover:border-blue-200 transition-all duration-200 active:scale-[0.99]"
                  >
                    <div className="flex justify-between items-start gap-2 mb-3">
                    ...
                    <div className="text-base font-bold text-slate-900 mb-2 break-words">
                      {clientName}
                    </div>
